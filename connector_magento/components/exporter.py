...
class MagentoBaseExporter(AbstractComponent):
    ...
    def _delay_import(self):
        ...
        self.binding.with_delay().import_record(self.backend_record, self.external_id, force=True)
...
class MagentoExporter(AbstractComponent):
    ...
    def _export_dependency(
        ...
        **kwargs,
        ...
        if wrap and hasattr(relation, binding_field):
            domain = [("odoo_id", "=", relation.id), ("backend_id", "=", self.backend_record.id)]
            ...
            # depends.
                ...
                bind_values = {"backend_id": self.backend_record.id, "odoo_id": relation.id}
    ...
    def _get_binding(self, model, _id):
        return self.env[model].search(
            [("odoo_id", "=", _id), ("backend_id", "=", self.backend_record.id)]
        )
