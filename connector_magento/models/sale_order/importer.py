...
class SaleOrderBatchImporter(Component):
    ...
    def run(self, filters=None):
        ...
        _logger.info("search for magento saleorders %s returned %s", filters, external_ids)
...
class SaleOrderImportMapper(Component):
    ...
    def _add_shipping_line(self, map_record, values):
        ...
        if self.options.tax_include:
            ...
            amount = float(record.get("base_shipping_amount") or 0.0) - discount
...
class SaleOrderImporter(Component):
    ...
    def _import_addresses(self):
        ...
        if is_guest_order:
            ...
            mapper = self.component(usage="import.mapper", model_name="magento.res.partner")
            ...
            importer = self.component(usage="record.importer", model_name="magento.res.partner")
        ...
        addr_mapper = self.component(usage="import.mapper", model_name="magento.address")
        ...
        if self.collection.version == "1.7":
            ...
            shipping_address = shippings[0]["shipping"].get("address") if shippings else None
        if shipping_address:
    ...
    def _check_special_fields(self):
        assert self.partner_id, (
            "self.partner_id should have been defined in SaleOrderImporter._import_addresses"
        )
