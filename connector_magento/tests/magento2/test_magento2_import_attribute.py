...
class TestImportAttribute(Magento2SyncTestCase):
    ...
    def _import_attribute(self, attr_id):
        ...
        return self._import_record(
            'magento.product.attribute', attr_id, cassette=True)
    ...
    def test_import_attribute_set(self):
        ...
        self.assertTrue(binding.attribute_ids,
                        "Attribute set should have attributes linked")
    ...
    def test_import_attribute_select(self):
        ...
        self.assertEqual(len(color_binding), 1,
                         "Color attribute should be imported")
    ...
    def test_import_attribute_values(self):
        ...
        self.assertGreaterEqual(len(value_bindings), 2,
                                "Color should have at least 2 values (Red, Blue)")
    ...
    def test_import_attribute_idempotent(self):
        ...
        self.assertEqual(count1, count2,
                         "Re-import should not duplicate attributes")
