...
ATTRIBUTE_SETS = {
    ...
    10: "Bottom",
    11: "Gear",
    12: "Sprite Stasis Ball",
    13: "Sprite Yoga Companion Kit",
}
...
KNOWN_ATTRS = {
    ...
    "image": 105,
    "is_anchor": 106,
    "msrp_display_actual_price_type": 107,
    "options_container": 108,
    "path": 109,
    ...
    "meta_title": 116,
    "meta_keyword": 117,
    "meta_description": 118,
    "name": 73,
    "price": 77,
    "status": 119,
    "visibility": 120,
    "weight": 121,
    "short_description": 122,
    "special_price": 123,
    "special_from_date": 124,
    "special_to_date": 125,
    "gift_message_available": 126,
    "news_from_date": 127,
    "news_to_date": 128,
    "country_of_manufacture": 129,
    "custom_layout_update": 130,
    "page_layout": 131,
    "activity": 132,
    "style_general": 133,
    "material": 134,
    ...
    "strap_bags": 148,
    "style_bottom": 149,
    "custom_apply_to_products": 150,
    "custom_use_parent_settings": 151,
    "category_gear": 153,
    "ts_dimensions_length": 154,
    "ts_dimensions_width": 155,
    "ts_dimensions_height": 156,
}
...
def collect_needed_interactions(raw_text):
    ...
    tax_class_search_uri = (
        f"{BASE_URL}/taxClasses/search?fields=items%5Bclass_id%5D&searchCriteria="
    )
    ...
    for tax_id, tax_name, tax_type in [
        ...
        for base in [BASE_URL, BASE_URL_ALL]:
            ...
            if uri not in existing_uris:
                body = json.dumps(
                    {"class_id": tax_id, "class_name": tax_name, "class_type": tax_type}
                )
                needed.append((uri, body))
                existing_uris.add(uri)
...
def duplicate_consumed_interactions(raw_text):
    ...
    return [
        ("__RAW_BLOCK__", block) for block in raw_blocks for _ in range(DUPLICATE_COUNT)
    ]
...
def main():
    ...
    for fpath in cassette_files:
        ...
        if added:
            ...
            print(
                f"  {prefix}{os.path.basename(fpath)}: +{len(added)} ({preview}{suffix})"
            )
