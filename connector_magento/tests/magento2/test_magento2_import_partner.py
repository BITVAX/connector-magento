...
class TestImportPartner(Magento2SyncTestCase):
    ...
    def test_import_partner_individual_1_address(self):
        ...
        self.assertEqual(
            address_bind.external_id, "1", msg="The merged address should be the billing address"
        )
    ...
    def test_import_partner_individual_2_addresses(self):
        ...
        address_bind = partner.magento_address_bind_ids[0]
        self.assertEqual(
            address_bind.external_id, "2", msg="The merged address should be the billing address"
        )
        self.assertEqual(
