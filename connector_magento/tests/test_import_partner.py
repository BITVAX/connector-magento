...
class TestImportPartner(MagentoSyncTestCase):
    def setUp(self):
        ...
        self.create_binding_no_export("magento.res.partner.category", existing_category, 1)
    ...
    def test_import_partner_individual_1_address(self):
        ...
        self.assertEqual(
            address_bind.external_id, "92", msg="The merged address should be the billing address"
        )
    ...
    def test_import_partner_individual_2_addresses(self):
        ...
        address_bind = partner.magento_address_bind_ids[0]
        self.assertEqual(
            address_bind.external_id, "35", msg="The merged address should be the billing address"
        )
        self.assertEqual(
    ...
    def test_import_partner_company_2_addresses(self):
        ...
        self.assertEqual(
            address.type, "invoice", msg="The billing address should be of type 'invoice'"
        )
        # shipping address
        address = get_address("98")
        self.assertEqual(
            address.type, "delivery", msg="The shipping address should be of type 'delivery'"
        )
