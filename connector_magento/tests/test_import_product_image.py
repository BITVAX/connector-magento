...
class TestImportProductImage(TransactionComponentRegistryCase):
    ...
    def setUp(self):
        ...
        self.image_importer = self.work.component_by_name("magento.product.image.importer")
    ...
    def test_image_priority(self):
        ...
        self.assertEqual(self.image_importer._sort_images(images), [file4, file3, file2, file1])
